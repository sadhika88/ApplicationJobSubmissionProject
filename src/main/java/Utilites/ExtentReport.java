...
import TestCase.ClientJobApplicationExecuted;
...
public class ExtentReport implements ITestListener{
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("ApplicationJobSubmissionProject");
		sparkReporter.config().setReportName("ApplicationJobSubmissionProject FunctionalTesting");
		...
		extent.setSystemInfo("Browser name", "Chrome");
			...
			driver =ClientJobApplicationExecuted .driver;
